...
if __name__ == "__main__":
    ...
    parser.add_argument("--vap_model", type=str, default='../../asset/vap/vap_state_dict_jp_10hz_5000msec.pt')
    ...
    # parser.add_argument("--input_wav_lft", type=str, default='wav/101_1_2-left-ope.wav')
